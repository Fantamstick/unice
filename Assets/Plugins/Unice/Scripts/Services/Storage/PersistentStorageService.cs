...
[CreateAssetMenu(fileName = "persistent storage service", menuName = "App/Services/PersistentStorage")]
public class PersistentStorageService : StorageService {
    /// <summary>
    /// Save string data.
    /// </summary>
    ...
    public override UniTask<(string data, string error)> LoadAsync(string key) {
        ...
        try {
            ...
            string data = Encoding.UTF8.GetString(jsonDataAsBytes);
